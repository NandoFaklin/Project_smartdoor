...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  static List<Widget> _screens = <Widget>[
    HomeScreen(),
    NotificationsScreen(),
    Dashboard(authBloc: AuthBloc(authRepository: AuthRepository()))
  ];
...
class Dashboard extends StatefulWidget {
  ...
  const Dashboard({Key? key, required this.authBloc}) : super(key: key);
